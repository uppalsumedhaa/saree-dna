...
- **Hero image is a placeholder.** `/public/hero.png` was sourced from ANKA's Instagram (unlicensed). Must be replaced with a licensed/owned image before any public launch. TODO comment in `app/page.tsx` flags this in code.
