...
Pre-build. Scoping in progress. **8 questions locked (Q1–Q8). Matrix v1.3 designed. Awaiting stress test v3.**

| Feature | Status | Doc |
|---|---|---|
| Quiz v1 (8-question archetype quiz) | 8 questions locked (Q1–Q8) + scoring matrix v1.3 (four-level tiebreak hierarchy) | [docs/features/quiz-v1.md](docs/features/quiz-v1.md) |
