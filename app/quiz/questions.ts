...
export const questions: Question[] = [
  {
    ...
    options: [
      ...
      { id: "B", text: "Already at the Sunday flea market" },
  ...
  {
    id: 2,
    stem: "What does your bedside look like?",
    options: [
      {
        id: "A",
  ...
  {
    id: 7,
    stem: "What could be the last text you sent?",
    options: [
      ...
      { id: "D", text: "A photo from a city you didn't tell anyone you were in" },
    ],
  },
  {
    id: 8,
